...
const Hero = ({name='NAME',text=' I Build Friendly Web Experiences, deploy them to cloud and can vizualize using Python and PowerBI. Known to make life Easy End to End.'}) => {
    return ( 
